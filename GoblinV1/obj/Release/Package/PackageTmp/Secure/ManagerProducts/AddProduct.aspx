<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ProductManager.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="GoblinV1.Secure.Staff.AddProduct" %>
    ...
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="GoblinV1.Models.Product"
