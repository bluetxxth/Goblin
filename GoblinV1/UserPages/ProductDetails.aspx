...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMain" runat="server">
        <asp:FormView ID="productDetail" runat="server" ItemType="Gbl.Models.Product" SelectMethod ="GetProduct" RenderOuterTable="false">
        <ItemTemplate>
            <div>
            ...
            <table>
                <tr>
                    ...
                    <td style="vertical-align: top; text-align:left;">
                        <b>Description:</b><br /><%#:Item.Specifications%><br /><span><b>Price:</b>&nbsp;<%#: String.Format("{0:c}", Item.Price) %></span><br /><span><b>Product Number:</b>&nbsp;<%#:Item.ProductId %></span><br /></td>
                </tr>
            </table>
        </ItemTemplate>
    </asp:FormView>
