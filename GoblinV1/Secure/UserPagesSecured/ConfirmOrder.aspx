...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <asp:Repeater ID="rptConfirmOrder" runat="server">
        <ItemTemplate>
            <tr>
                <!--Customer Data-->
                <fieldset class = "OrderConfirmationFieldset"><legend class ="OrderDataLegend">Customer Data</legend>
                <td align="left" width="10%" runat="server" id="Td1">
                    ...
                    </asp:Label> <%# Eval("CustomerName" ,"{0:c}" )  %>
                    <br />
                </td>
                ...
                <td align="left" width="60%" runat="server" id="Td2">
                    ...
                    </asp:Label> <%# Eval("CustomerMiddle" ,"{0:c}" )  %>
                    <br />
                </td>
                ...
                <td align="left" width="60%" runat="server" id="Td3">
                    ...
                    </asp:Label> <%# Eval("Customerlast" ,"{0:c}" )  %>
                    <br />
                </td>
                ...
                <td align="left" width="60%" runat="server" id="Td4">
                    ...
                    </asp:Label> <%# Eval("CustomerPhone" ,"{0:c}" )  %>
                    <br />
                </td>
                ...
                <td align="left" width="60%" runat="server" id="Td5">
                    ...
                    </asp:Label>  <%# Eval("CustomerCell" ,"{0:c}" )  %>
                    <br />
                </td>
                <td align="left" width="60%" runat="server" id="Td6">
                    ...
                    </asp:Label> <%# Eval("CustomerEmail" ,"{0:c}" )  %>
                    <br />
                </td>
            </fieldset> <!--End customer data-->

                <!--Address-->
                <fieldset class = "OrderConfirmationFieldset"><legend class ="OrderDataLegend">Billing Address</legend>
                <td align="left" width="60%" runat="server" id="Td7">
                    ...
                    </asp:Label> <%# Eval("BillingAddressName" ,"{0:c}" )  %>
                    <br />
                </td>
                <td align="left" width="60%" runat="server" id="Td8">
                    ...
                    </asp:Label> <%# Eval("BillingAddressNo" ,"{0:c}" )  %>
                    <br />
                </td>
                <td align="left" width="60%" runat="server" id="Td9">
                    ...
                    </asp:Label> <%# Eval("BillingApartment" ,"{0:c}" )  %>
                    <br />
                </td>
                <td align="left" width="60%" runat="server" id="Td10">
                    ...
                    </asp:Label> <%# Eval("BillingStair" ,"{0:c}" )  %>
                    <br />
                </td>
                <td align="left" width="60%" runat="server" id="Td11">
                    ...
                    </asp:Label>  <%# Eval("BillingZipCode" ,"{0:c}" )  %>
                    <br />
                </td>
                <td align="left" width="60%" runat="server" id="Td12">
                    ...
                    </asp:Label> <%# Eval("BillingCountry" ,"{0:c}" )  %>
                    <br />
                ...
                <td align="left" width="60%" runat="server" id="Td13">
                    ...
                    </asp:Label> <%# Eval("BillingCity" ,"{0:c}" )  %>
                    <br />
                </td>
                 </fieldset><!--End Billind address-->

                <fieldset class = "OrderConfirmationFieldset"><legend class ="OrderDataLegend">Shipping Address</legend>
                <td align="left" width="60%" runat="server" id="Td14">
                    ...
                    </asp:Label> <%# Eval("ShippingAddressName" ,"{0:c}" )  %>
                    <br />
                ...
                <td align="left" width="60%" runat="server" id="Td15">
                    ...
                    </asp:Label> <%# Eval("ShippingAddressNo" ,"{0:c}" )  %>
                    <br />
                </td>
                <td align="left" width="60%" runat="server" id="Td16">
                    ...
                    </asp:Label> <%# Eval("ShippingApartment" ,"{0:c}" )  %>
                    <br />
                </td>
                <td align="left" width="60%" runat="server" id="Td17">
                    ...
                    </asp:Label> <%# Eval("ShippingStair" ,"{0:c}" )  %>
                    <br />
                </td>
                <td align="left" width="60%" runat="server" id="Td18">
                    ...
                    </asp:Label>  <%# Eval("ShippingZipCode" ,"{0:c}" )  %>
                    <br />
                </td>
                <td align="left" width="60%" runat="server" id="Td19">
                    ...
                    </asp:Label>  <%# Eval("ShippingCountry" ,"{0:c}" )  %>
                    <br />
                </td>
                <td align="left" width="60%" runat="server" id="Td20">
                    ...
                    </asp:Label> <%# Eval("ShippingCity" ,"{0:c}" )  %>
                    <br />
                </td>
                </fieldset> <!--End shipping address-->

                <fieldset class = "OrderConfirmationFieldset"><legend class ="OrderDataLegend">Credit Card info</legend>
                ...
                <td align="left" width="60%" runat="server" id="Td23">
                    ...
                    </asp:Label> <%# Eval("CCardExpiryDate" ,"{0:c}" )  %>
                    <br />
                </td>
                ...
                <td align="left" width="60%" runat="server" id="Td24">
                    ...
                    </asp:Label> <%# Eval("CCardSecurityCode" ,"{0:c}" )  %>
                    <br />
                </td>

                </fieldset><!--End credit card data-->
               ...
               <fieldset class = "OrderConfirmationFieldset"><legend class ="OrderDataLegend">Order Summary</legend>
                <td align="left" width="60%" runat="server" id="Td25">
                    <asp:Label ID="lblQuantity" runat="server" Text="Product quantity: " CssClass = "lblOrderConfirmation">
                    </asp:Label> <%# Eval("Quantity" ,"{0:c}" )  %>
                    <br />
