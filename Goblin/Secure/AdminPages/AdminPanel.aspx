<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/FrontEnd.Master" AutoEventWireup="true" CodeBehind="AdminPanel.aspx.cs" Inherits="Goblin.Secure.AdminPages.AdminPanel" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMain" runat="server">
     <asp:ListView ID="adminListView" runat="server"
        ...
        ItemType="Goblin.Model.Department" SelectMethod="GetDepartments">
